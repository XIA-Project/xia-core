...
host2 :: XIAEndHost (RE AD1 HID2, HID2, 1900, 1, aa:aa:aa:aa:aa:aa);
...
router0[0] -> LinkUnqueue(0.1, 25 Mbps) -> [0]host0;

host1[0] -> LinkUnqueue(0.005, 1 GB/s) -> [0]router1;
router1[0] -> LinkUnqueue(0.005, 1 GB/s) ->[0]host1;

host2[0] -> LinkUnqueue(0.005, 1 GB/s) -> [2]router1;
router1[2] -> LinkUnqueue(0.005, 1 GB/s) ->[0]host2;
