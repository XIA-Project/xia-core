...
#ifndef CONTEXT_MODULE_H
#define CONTEXT_MODULE_H
...
/* For attributes from the application */
enum SessionAttributeType {
	kServicePerformance,
	kSecurityPrivacy,
	kEnergy,
	kConnectivity
...
enum DecisionValue {
	...
	kInterfaceEthernet, //TODO: should this really be an enum? shouldn't it be "eth0", etc?
	kInterfaceWiFi,
	kInterfaceCellular,
...
class ContextModule {
	public:
		virtual DecisionValue makeDecision(DecisionType decision) = 0;
};


#endif /* CONTEXT_MODULE_H */
