...
plot "plot.dat" \
     ...
     ""     index 9 using ($1 * 1000 - 11000):($2) axes x1y1 with lines linewidth 2 lt 2 lc rgb "#ff00ff" title "VM frozen (final iteration)", \
     ""     index 11 using ($1 * 1000 - 11000):($2) axes x1y1 with lines linewidth 2 lt 3 lc rgb "#6a5acd" title "VM resumed \\& Server rebound", \
