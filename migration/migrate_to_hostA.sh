...
$PREFIX/qemu_monitor_cmd.py $HOST_B_IP 4444 "migrate tcp:$HOST_A_IP:6666"
...
sudo $CLICK_PATH/userlevel/click $CLICK_PATH/conf/xia/xia_vm_ping_update_hostA.click
