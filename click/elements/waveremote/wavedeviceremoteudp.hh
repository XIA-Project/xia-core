/**
 * wavedeviceremoteudp.{cc,hh} -- wave device remote interface, udp version
...
#ifndef CLICK_WAVEDEVICEREMOTEUDP_HH
#define CLICK_WAVEDEVICEREMOTEUDP_HH
 ...
 * ... -> WaveDeviceRemoteUdp() -> ...
 *
 * =a WaveDeviceRemote, WaveDevice
 */

class WaveDeviceRemoteUdp : public Element { public:

    WaveDeviceRemoteUdp();
    ~WaveDeviceRemoteUdp();

    const char *class_name() const	{ return "WaveDeviceRemoteUdp"; }
    ...
    struct sockaddr *get_remoteSockaddr() const;
    socklen_t get_sockaddrLen() const;
...
private:
    ...
    bool _isConnected;
    int _remoteSockFd;
    struct sockaddr *_remoteSockaddr;
