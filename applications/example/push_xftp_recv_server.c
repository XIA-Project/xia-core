...
int registerReceiver()
{
	...
	if ( XreadLocalHostAddr(sock, localdag, XIA_MAX_DAG_STR_SIZE, my4ID, sizeof(my4ID)) < 0)
...
int donePush(int sock, char *reply, int sz)
{
	int n;
