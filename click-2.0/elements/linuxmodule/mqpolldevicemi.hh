#ifndef CLICK_MQPOLLDEVICEMI_HH
#define CLICK_MQPOLLDEVICEMI_HH

/*
=c

MQPollDevice(DEVNAME, QUEUE [, I<keywords> PROMISC, BURST, TIMESTAMP...])
...
Poll packets received by the Linux network interface named DEVNAME, queue number QUEUE. Packets
...
class MQPollDeviceMI : public AnyTaskDevice { public:
  ...
  const char *class_name() const	{ return "MQPollDeviceMI"; }
  ...
  unsigned _burst;
  unsigned _batch;
  unsigned _interfaces;
  unsigned _last_dev;
  unsigned _batch_left;
