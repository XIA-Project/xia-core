...
plot 'ip' u  2:($3*8*($2-34)/1000) w lp ls 2 title "IP" , \
     'fb0' u 2:($3*8*($2-98+20)/1000) w lp ls 4 title "XIA FB0",  \
     'fb1' u 2:($3*8*($2-126+20)/1000) w lp ls 6 title "XIA FB1",  \
     'fb2' u 2:($3*8*($2-154+20)/1000) w lp ls 8 title "XIA FB2" ,  \
     'fb3' u 2:($3*8*($2-182+20)/1000) w lp ls 10 title "XIA FB3", \
     'via' u 2:($3*8*($2-126+20)/1000) w lp ls 12 title "XIA VIA" axis x1y1
