...
sw[0]
-> XIAPrint("xia_vm_hostB:to_other")
-> EtherEncap(0x9999, RHID1, OTHER) -> to_eth0;

sw[1]
-> XIAPrint("xia_vm_hostB:to_guest")
-> EtherEncap(0x9999, RHID1, GUEST) -> to_tap0;

router[1]
-> XIAPrint("xia_vm_hostB:no_rpc")
-> Discard;

router[2]
-> XIAPrint("xia_vm_hostB:no_cache")
-> Discard;
