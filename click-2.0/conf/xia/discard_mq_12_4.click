...
pd_eth2_0:: MQPollDevice(eth2, QUEUE 0, BURST 32, PROMISC true) ->   CheckIPHeader2(14) ->Discard; 
pd_eth2_1:: MQPollDevice(eth2, QUEUE 1, BURST 32, PROMISC true) ->   CheckIPHeader2(14) ->Discard; 
pd_eth2_2:: MQPollDevice(eth2, QUEUE 2, BURST 32, PROMISC true) ->   CheckIPHeader2(14) ->Discard; 
pd_eth2_3:: MQPollDevice(eth2, QUEUE 3, BURST 32, PROMISC true) ->   CheckIPHeader2(14) ->Discard; 
pd_eth2_4:: MQPollDevice(eth2, QUEUE 4, BURST 32, PROMISC true) ->   CheckIPHeader2(14) ->Discard; 
pd_eth2_5:: MQPollDevice(eth2, QUEUE 5, BURST 32, PROMISC true) ->   CheckIPHeader2(14) ->Discard; 
pd_eth2_6:: MQPollDevice(eth2, QUEUE 6, BURST 32, PROMISC true) ->   CheckIPHeader2(14) ->Discard; 
pd_eth2_7:: MQPollDevice(eth2, QUEUE 7, BURST 32, PROMISC true) ->   CheckIPHeader2(14) ->Discard; 
pd_eth2_8:: MQPollDevice(eth2, QUEUE 8, BURST 32, PROMISC true) ->   CheckIPHeader2(14) ->Discard; 
pd_eth2_9:: MQPollDevice(eth2, QUEUE 9, BURST 32, PROMISC true) ->   CheckIPHeader2(14) ->Discard; 
pd_eth2_10:: MQPollDevice(eth2, QUEUE 10, BURST 32, PROMISC true) -> CheckIPHeader2(14) ->Discard; 
pd_eth2_11:: MQPollDevice(eth2, QUEUE 11, BURST 32, PROMISC true) -> CheckIPHeader2(14) ->Discard; 
