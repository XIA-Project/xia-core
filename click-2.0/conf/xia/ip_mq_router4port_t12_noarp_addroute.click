...
pd_eth2_6:: MQPollDevice(eth2, QUEUE 6, BURST 32, PROMISC true) -> c0; 
pd_eth2_7:: MQPollDevice(eth2, QUEUE 7, BURST 32, PROMISC true) -> c0; 
pd_eth2_8:: MQPollDevice(eth2, QUEUE 8, BURST 32, PROMISC true) -> c0; 
pd_eth2_9:: MQPollDevice(eth2, QUEUE 9, BURST 32, PROMISC true) -> c0; 
pd_eth2_10:: MQPollDevice(eth2, QUEUE 10, BURST 32, PROMISC true) -> c0; 
pd_eth2_11:: MQPollDevice(eth2, QUEUE 11, BURST 32, PROMISC true) -> c0; 
...
out0 -> tod_eth2_6 :: MQToDevice(eth2, QUEUE 6, BURST 32) 
out0 -> tod_eth2_7 :: MQToDevice(eth2, QUEUE 7, BURST 32) 
out0 -> tod_eth2_8 :: MQToDevice(eth2, QUEUE 8, BURST 32) 
out0 -> tod_eth2_9 :: MQToDevice(eth2, QUEUE 9, BURST 32) 
out0 -> tod_eth2_10 :: MQToDevice(eth2, QUEUE 10, BURST 32) 
out0 -> tod_eth2_11 :: MQToDevice(eth2, QUEUE 11, BURST 32) 
...
pd_eth3_6:: MQPollDevice(eth3, QUEUE 6, BURST 32, PROMISC true) -> c1; 
pd_eth3_7:: MQPollDevice(eth3, QUEUE 7, BURST 32, PROMISC true) -> c1; 
pd_eth3_8:: MQPollDevice(eth3, QUEUE 8, BURST 32, PROMISC true) -> c1; 
pd_eth3_9:: MQPollDevice(eth3, QUEUE 9, BURST 32, PROMISC true) -> c1; 
pd_eth3_10:: MQPollDevice(eth3, QUEUE 10, BURST 32, PROMISC true) -> c1; 
pd_eth3_11:: MQPollDevice(eth3, QUEUE 11, BURST 32, PROMISC true) -> c1; 
...
out1 -> tod_eth3_6 :: MQToDevice(eth3, QUEUE 6, BURST 32) 
out1 -> tod_eth3_7 :: MQToDevice(eth3, QUEUE 7, BURST 32) 
out1 -> tod_eth3_8 :: MQToDevice(eth3, QUEUE 8, BURST 32) 
out1 -> tod_eth3_9 :: MQToDevice(eth3, QUEUE 9, BURST 32) 
out1 -> tod_eth3_10 :: MQToDevice(eth3, QUEUE 10, BURST 32) 
out1 -> tod_eth3_11 :: MQToDevice(eth3, QUEUE 11, BURST 32) 
...
pd_eth4_6:: MQPollDevice(eth4, QUEUE 6, BURST 32, PROMISC true) -> c2; 
pd_eth4_7:: MQPollDevice(eth4, QUEUE 7, BURST 32, PROMISC true) -> c2; 
pd_eth4_8:: MQPollDevice(eth4, QUEUE 8, BURST 32, PROMISC true) -> c2; 
pd_eth4_9:: MQPollDevice(eth4, QUEUE 9, BURST 32, PROMISC true) -> c2; 
pd_eth4_10:: MQPollDevice(eth4, QUEUE 10, BURST 32, PROMISC true) -> c2; 
pd_eth4_11:: MQPollDevice(eth4, QUEUE 11, BURST 32, PROMISC true) -> c2; 
...
out2 -> tod_eth4_6 :: MQToDevice(eth4, QUEUE 6, BURST 32) 
out2 -> tod_eth4_7 :: MQToDevice(eth4, QUEUE 7, BURST 32) 
out2 -> tod_eth4_8 :: MQToDevice(eth4, QUEUE 8, BURST 32) 
out2 -> tod_eth4_9 :: MQToDevice(eth4, QUEUE 9, BURST 32) 
out2 -> tod_eth4_10 :: MQToDevice(eth4, QUEUE 10, BURST 32) 
out2 -> tod_eth4_11 :: MQToDevice(eth4, QUEUE 11, BURST 32) 
...
pd_eth5_6:: MQPollDevice(eth5, QUEUE 6, BURST 32, PROMISC true) -> c3; 
pd_eth5_7:: MQPollDevice(eth5, QUEUE 7, BURST 32, PROMISC true) -> c3; 
pd_eth5_8:: MQPollDevice(eth5, QUEUE 8, BURST 32, PROMISC true) -> c3; 
pd_eth5_9:: MQPollDevice(eth5, QUEUE 9, BURST 32, PROMISC true) -> c3; 
pd_eth5_10:: MQPollDevice(eth5, QUEUE 10, BURST 32, PROMISC true) -> c3; 
pd_eth5_11:: MQPollDevice(eth5, QUEUE 11, BURST 32, PROMISC true) -> c3; 
...
out3 -> tod_eth5_6 :: MQToDevice(eth5, QUEUE 6, BURST 32) 
out3 -> tod_eth5_7 :: MQToDevice(eth5, QUEUE 7, BURST 32) 
out3 -> tod_eth5_8 :: MQToDevice(eth5, QUEUE 8, BURST 32) 
out3 -> tod_eth5_9 :: MQToDevice(eth5, QUEUE 9, BURST 32) 
out3 -> tod_eth5_10 :: MQToDevice(eth5, QUEUE 10, BURST 32) 
out3 -> tod_eth5_11 :: MQToDevice(eth5, QUEUE 11, BURST 32) 
...
Script(write host0/rt.load /home/dongsuh/xia-core/click-2.0/conf/xia/ip_routes_4.txt);
