...
sleep 1
sh ~/xia-core/click-2.0/conf/geni/stats/xia-link-state.sh | ~/xia-core/click-2.0/conf/geni/visualizer-scripts/updateForwardingRate.py H0-R0 ganel.gpolab.bbn.com &
