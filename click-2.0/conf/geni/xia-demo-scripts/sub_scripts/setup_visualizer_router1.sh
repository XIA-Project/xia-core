...
sleep 1
sh ~/xia-core/click-2.0/conf/geni/stats/xia-link-state.sh | ~/xia-core/click-2.0/conf/geni/visualizer-scripts/updateForwardingRate.py R0-R1 ganel.gpolab.bbn.com &
