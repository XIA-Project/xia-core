...
ssh -A mberman@pg55.emulab.net -f  "cd vis-scripts; sleep 5; sudo killall -9 python updateForwardingRate.py H0-R0 utah; sh ../xia-core/click-2.0/conf/geni/stats/xia-link-state.sh | python updateForwardingRate.py H0-R0 utah; exit "
...
ssh -A mberman@pg42.emulab.net -f  "cd vis-scripts; sleep 5; sudo killall -9 python updateForwardingRate.py R0-R1 utah; sh ../xia-core/click-2.0/conf/geni/stats/xia-link-state.sh | python updateForwardingRate.py R0-R1 utah; exit "
...
ssh -A mberman@pg40.emulab.net -f  "cd vis-scripts; sleep 5; sudo killall -9 python updateForwardingRate.py R1-H1 utah; sh ../xia-core/click-2.0/conf/geni/stats/xia-link-state.sh | python updateForwardingRate.py R1-H1 utah; exit "
