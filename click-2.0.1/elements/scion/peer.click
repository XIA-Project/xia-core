...
//Gateway for AD5
encap5::SCIONEncap(AID 222, 
CONFIG_FILE "./TD1/Non-TDC/AD5/gateway/conf/AD5GW.conf", 
TOPOLOGY_FILE "./TD1/Non-TDC/AD5/topology5.xml", 
ADDR_TABLE "./TD1/Non-TDC/AD5/gateway/conf/addrtable.conf",
PATHINFO pathinfo5)
...
//Gateway for AD6
encap6::SCIONEncap(AID 222, 
CONFIG_FILE "./TD1/Non-TDC/AD6/gateway/conf/AD6GW.conf", 
TOPOLOGY_FILE "./TD1/Non-TDC/AD6/topology6.xml", 
ADDR_TABLE "./TD1/Non-TDC/AD6/gateway/conf/addrtable.conf",
PATHINFO pathinfo6)
...
//Gateway for AD7
encap7::SCIONEncap(AID 222, 
CONFIG_FILE "./TD1/Non-TDC/AD7/gateway/conf/AD7GW.conf", 
TOPOLOGY_FILE "./TD1/Non-TDC/AD7/topology7.xml", 
ADDR_TABLE "./TD1/Non-TDC/AD7/gateway/conf/addrtable.conf",
PATHINFO pathinfo7)
...
TimedSource(INTERVAL 0.001)->IPEncap(4, 192.168.0.5, 192.168.0.7)->Print("Gateway5 Send")->[0]encap5;
//InfiniteSource(DATA \< 0800>, LENGTH 1500, BURST 100)->IPEncap(4, 192.168.0.5, 192.168.0.7)->Print("Gateway5 Send")->[0]encap5;
encap5[0]->[1]gateway5;
gateway5[1]->[1]encap5;
...
TimedSource(INTERVAL 0.001,DATA \<00 00 00 00 11 11 11 11
...
11 11 11 11 11 11 11 11 01 02 03 04 05 06 07 08
11 11 11 11 11 11 11 11 01 02 03 04 05 06 07 08
//>, LENGTH 1500, BURST 100)->IPEncap(4, 192.168.0.6, 192.168.0.7)->Print("Gateway6 Send")->[0]encap6;
>)->IPEncap(4, 192.168.0.6, 192.168.0.7)->Print("Gateway6 Send")->[0]encap6;
encap6[0]->[1]gateway6;
gateway6[1]->[1]encap6;
...
11 11 11 11 11 11 11 11 01 02 03 04 05 06 07 08
11 11 11 11 11 11 11 11 01 02 03 04 05 06 07 08
//>, LENGTH 1500, BURST 100)->IPEncap(4, 192.168.0.7, 192.168.0.6)->Print("Gateway7 Send")->[0]encap7;
>)->IPEncap(4, 192.168.0.7, 192.168.0.6)->Print("Gateway7 Send")->[0]encap7;
encap7[0]->[1]gateway7;
gateway7[1]->[1]encap7;
