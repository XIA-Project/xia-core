...
class Config {
  ...
  */
  ...
  /**
      @brief AD ROT File name
  */
  char m_csROTFile[MAX_FILE_LEN+1];
  /**
  ...
  */
  ...
  /**
      @brief Gets the path of ROT File of the calling AD.
      @param char* fn The buffer where the ROT file path is stored.

      The path of the ROT file will be passed to the char* fn.
  */
  bool getROTFilename(char *fn);
