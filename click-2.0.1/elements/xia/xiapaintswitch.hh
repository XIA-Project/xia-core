#ifndef CLICK_XIAPAINTSWITCH_HH
#define CLICK_XIAPAINTSWITCH_HH
...
XIAPaintSwitch sends every incoming packet to one of its output ports --
...
class XIAPaintSwitch : public Element { public:

    XIAPaintSwitch();
    ~XIAPaintSwitch();

    const char *class_name() const		{ return "XIAPaintSwitch"; }
