...
class XIAContentModule {
    ...
    // only used in client. When refresh timer is fired, _oldPartial is 
    // cleared and everything in _partialTable goes to _oldPartial. 
    // It takes two timers to clear on-going partial chunk transfers.	
		HashTable<XID, CChunk*>_oldPartial; 
