certserver1::SCIONCertServerCore(AID 33333, TOPOLOGY_FILE ./AD1/topology1.xml,
CONFIG_FILE ./AD1/AD1.conf, ROT_FILE ./ROT/ROT.xml)
certserver2::SCIONCertServer(AID 33333, TOPOLOGY_FILE ./AD2/topology2.xml,
CONFIG_FILE ./AD2/AD2.conf, ROT_FILE ./ROT/ROT.xml)
certserver3::SCIONCertServer(AID 33333, TOPOLOGY_FILE ./AD3/topology3.xml,
CONFIG_FILE ./AD3/AD3.conf, ROT_FILE ./ROT/ROT.xml)
certserver4::SCIONCertServer(AID 33333, TOPOLOGY_FILE ./AD4/topology4.xml,
CONFIG_FILE ./AD4/AD4.conf, ROT_FILE ./ROT/ROT.xml)
certserver5::SCIONCertServer(AID 33333, TOPOLOGY_FILE ./AD5/topology5.xml,
CONFIG_FILE ./AD5/AD5.conf, ROT_FILE ./ROT/ROT.xml)
certserver6::SCIONCertServer(AID 33333, TOPOLOGY_FILE ./AD6/topology6.xml,
CONFIG_FILE ./AD6/AD6.conf, ROT_FILE ./ROT/ROT.xml)
certserver7::SCIONCertServer(AID 33333, TOPOLOGY_FILE ./AD7/topology7.xml,
CONFIG_FILE ./AD7/AD7.conf, ROT_FILE ./ROT/ROT.xml)



//client6::SCIONClient(ADAID 6, TARGET 5, PATHSERVER 22222, LOGFILE "./AD6/AD6C1.log", LOGLEVEL 300, AID 111)

//client7::SCIONClient(ADAID 7, TARGET 6, PATHSERVER 22222, LOGFILE "./AD7/AD7C1.log", LOGLEVEL 300, AID 111)
...
pathserver5::SCIONPathServer(AID 22222, CONFIG ./AD5/AD5.conf, TOPOLOGY
./AD5/topology5.xml);

pathserver6::SCIONPathServer(AID 22222, CONFIG ./AD6/AD6.conf, TOPOLOGY
./AD6/topology6.xml);

pathserver7::SCIONPathServer(AID 22222, CONFIG ./AD7/AD7.conf, TOPOLOGY
./AD7/topology7.xml);
...
//client6[0]->[3]switch6;
//switch6[3]->Queue(1000)->[0]client6;

switch6[3]->[0]gateway6;
gateway6[0]->[3]switch6;

TimedSource(INTERVAL 5)->IPEncap(4, 192.168.0.3, 192.168.0.2)->Print("Gateway6 Send")->[0]encap6;
encap6[0]->Print("Encap6")->[1]gateway6;
gateway6[1]->[1]encap6;

gateway6[2]->Print("Gateway6 Recv")->[0]decap6->Print("Decap6")->Discard;

//client7[0]->[3]switch7;
//switch7[3]->Queue(1000)->[0]client7;

switch7[3]->[0]gateway7;
gateway7[0]->[3]switch7;

TimedSource(INTERVAL 5)->IPEncap(4, 192.168.0.2, 192.168.0.3)->Print("Gateway7 Send")->[0]encap7;
encap7[0]->Print("Encap7")->[1]gateway7;
gateway7[1]->[1]encap7;

gateway7[2]->Print("Gateway7 Recv")->[0]decap7->Print("Decap7")->Discard;
